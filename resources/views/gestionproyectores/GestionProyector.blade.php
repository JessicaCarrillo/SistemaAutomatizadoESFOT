        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modalDevolver">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form  method="POST"  action="/DevolverProyector" id="Devolver" role="form" >
                        {{csrf_field()}}
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="observaciond" name="observaciond"></textarea>
                            </div>
...
@section('javascript')
    ...
    /*  $('#pro input').click(function() {
          myRoomNumber = $(this).attr('data-estado');
      ...
      function myFunction(id) {
          ...
          if(!hora_entrega.val() ) {
              hora_entrega.closest('.form-group').removeClass("has-success").addClass("has-error");
              event.preventDefault();
          } else {
              hora_entrega.closest('.form-group').removeClass('has-error').addClass('has-success');
              if (confirm("Esta seguro de la reserva!!")) {
    ...
    /*  swal({
          ...
          $.ajax({
              ...
              success:function(data) {
                 // console.log(data);
                  ...
                  $("#disponible-13").attr('data-estado',m);
                  $("#disponible-14").attr('data-estado',n);
                  $("#disponible-15").attr('data-estado',o);
                  $("#disponible-16").attr('data-estado',p);
                  $("#disponible-17").attr('data-estado',q);
                  $("#disponible-18").attr('data-estado',r);
      ...
      $(document).ready(function(){
         ...
         /* $('#Devolver').on('submit', function(e) {
              var observacion = $('#observaciond');
              //console.log(observacion);

              if(!observacion.val() ) {
                  observacion.closest('.form-group').removeClass("has-success").addClass("has-error");
                  e.preventDefault();
              } else {
                  observacion.closest('.form-group').removeClass('has-error').addClass('has-success');
                  remover();
              }
          });
